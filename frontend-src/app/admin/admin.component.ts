...
export class AdminComponent implements OnInit {
  ...
  constructor(private router : Router, private nService : NekretnineService) { }
  ...
  promena() {
    ...
    if(this.izbor == "poCeniProd") {
      ...
      this. naslov = "Nekretnine na prodaju po cenovnim rangovima";
    ...
    if(this.izbor == "poCeniIzd") {
      ...
      this. naslov = "Nekretnine za izdavanje po cenovnim rangovima";
